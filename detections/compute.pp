...
query "audit_logs_detect_compute_firewall_rule_deletion_updates" {
  sql = <<-EOQ
    select
      ${local.audit_logs_detect_compute_firewall_rule_deletion_updates_sql_columns}
    from
      gcp_audit_log
    where
      service_name = 'compute.googleapis.com'
...
query "audit_logs_detect_vpn_tunnel_deletions" {
  sql = <<-EOQ
    select
      ${local.audit_logs_detect_vpn_tunnel_deletions_sql_columns}
    from
      gcp_audit_log
    where
      service_name = 'compute.googleapis.com'
...
query "audit_logs_detect_full_network_traffic_packet_deletions" {
  sql = <<-EOQ
    select
      ${local.audit_logs_detect_full_network_traffic_packet_deletions_sql_columns}
    from
      gcp_audit_log
    where
      service_name = 'compute.googleapis.com'
...
query "audit_logs_detect_full_network_traffic_packet_modifications" {
  sql = <<-EOQ
    select
      ${local.audit_logs_detect_full_network_traffic_packet_modifications_sql_columns}
    from
      gcp_audit_log
    where
      service_name = 'compute.googleapis.com'
...
query "audit_logs_detect_compute_images_set_iam_policy" {
  sql = <<-EOQ
    select
      ${local.audit_logs_detect_compute_images_set_iam_policy_sql_columns}
    from
      gcp_audit_log
    where
      service_name = 'compute.googleapis.com'
...
query "audit_logs_detect_compute_disks_set_iam_policy" {
  sql = <<-EOQ
    select
      ${local.audit_logs_detect_compute_disks_set_iam_policy_sql_columns}
    from
      gcp_audit_log
    where
      service_name = 'compute.googleapis.com'
...
query "audit_logs_detect_compute_snapshots_set_iam_policy" {
  sql = <<-EOQ
    select
      ${local.audit_logs_detect_compute_snapshots_set_iam_policy_sql_columns}
    from
      gcp_audit_log
    where
      service_name = 'compute.googleapis.com'
...
query "audit_logs_detect_compute_instances_with_public_network_interfaces" {
  sql = <<-EOQ
    select
      ${local.audit_logs_detect_compute_instances_with_public_network_interfaces_sql_columns}
    from
      gcp_audit_log
    where
      service_name = 'compute.googleapis.com'
...
query "audit_logs_detect_public_ip_address_creation" {
  sql = <<-EOQ
    select
      ${local.audit_logs_detect_public_ip_address_creation_sql_columns}
    from
      gcp_audit_log
    where
      service_name = 'compute.googleapis.com'
...
query "audit_logs_detect_vpc_network_shared_to_external_project" {
  sql = <<-EOQ
    select
      ${local.audit_logs_detect_vpc_network_shared_to_external_project_sql_columns}
    from
      gcp_audit_log
    where
      service_name = 'compute.googleapis.com'
...
// testing needed
query "audit_logs_detect_compute_disk_size_small" {
  sql = <<-EOQ
    select
      ${local.audit_logs_detect_compute_disk_size_small_sql_columns}
    from
      gcp_audit_log
    where
      service_name = 'compute.googleapis.com'
...
// testing needed
query "audit_logs_detect_disable_compute_vpc_flow_logs" {
  sql = <<-EOQ
    select
      ${local.audit_logs_detect_disable_compute_vpc_flow_logs_sql_columns}
    from
      gcp_audit_log
    where
      service_name = 'compute.googleapis.com'
