locals {
  ...
  audit_log_admin_activity_detect_service_account_key_deletions_sql_columns                         = replace(local.audit_log_admin_activity_detection_sql_columns, "__RESOURCE_SQL__", "resource_name")
  ...
  audit_log_admin_activity_detect_iam_roles_permission_revocations_sql_columns = replace(local.audit_log_admin_activity_detection_sql_columns, "__RESOURCE_SQL__", "resource_name")
...
detection "audit_log_admin_activity_detect_service_account_key_deletions" {
  ...
  query           = query.audit_log_admin_activity_detect_service_account_key_deletions
  severity        = "medium"
  display_columns = local.audit_log_admin_activity_detection_display_columns
...
detection "audit_log_admin_activity_detect_iam_roles_permission_revocations" {
  ...
  severity        = "medium"
  query           = query.audit_log_admin_activity_detect_iam_roles_permission_revocations
  display_columns = local.audit_log_admin_activity_detection_display_columns
...
query "audit_log_admin_activity_detect_service_account_key_deletions" {
  sql = <<-EOQ
    select
      ${local.audit_log_admin_activity_detect_service_account_key_deletions_sql_columns}
    from
      gcp_audit_log_admin_activity
    where
      service_name = 'iam.googleapis.com'
...
query "audit_log_admin_activity_detect_iam_roles_permission_revocations" {
  sql = <<-EOQ
    select
      ${local.audit_log_admin_activity_detect_iam_roles_permission_revocations_sql_columns}
    from
      gcp_audit_log_admin_activity
    where
      service_name = 'iam.googleapis.com'
